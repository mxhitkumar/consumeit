...
class Service(TimeStampedModel):
    ...
    who_its_for = models.TextField(blank=True, default="")
    whats_included = models.TextField(blank=True, default="")
    expected_results = models.TextField(blank=True, default="")
    timeline_text = models.CharField(max_length=120, blank=True, default="")
    starting_price = models.CharField(max_length=120, blank=True, default="")
    cta_text = models.CharField(max_length=80, blank=True, default="")
    cta_note = models.CharField(max_length=255, blank=True, default="")
